          ...
          <PriceWrapper>
            ...
            >
              <List spacing={3} textAlign="start" px={12}>
                ...
                <ListItem>
                  <ListIcon as={FaCheckCircle} color="green.500" />5 credits per
                  month
                </ListItem>

                <ListItem>
                  <ListIcon as={FaCheckCircle} color="green.500" />1 credit per
                  invite
                </ListItem>
                <ListItem>
                  <ListIcon as={FaCheckCircle} color="green.500" />
          ...
          <PriceWrapper>
            ...
            >
              <List spacing={3} textAlign="start" px={12}>
                ...
                <ListItem>
                  <ListIcon as={FaCheckCircle} color="green.500" />5 times more
